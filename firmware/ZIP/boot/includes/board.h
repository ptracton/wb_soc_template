...
static volatile CONSOLE *const _uart = ((CONSOLE *)1184);
...
static volatile RTCLIGHT *const _rtc = ((RTCLIGHT *)1120);
#endif	// RTC_ACCESS
#ifdef	BLKRAM_ACCESS
...
static volatile unsigned *const _date = ((unsigned *)1032);
#endif	// RTCDATE_ACCESS
#ifdef	SDSPI_SCOPE
#define	_BOARD_HAS_SDSPI_SCOPE
static volatile WBSCOPE *const _scope_sdcard = ((WBSCOPE *)1152);
#endif	// SDSPI_SCOPE
#ifdef	SDSPI_ACCESS
#define	_BOARD_HAS_SDSPI
static volatile SDSPI *const _sdcard = ((SDSPI *)1088);
#endif	// SDSPI_ACCESS
//
