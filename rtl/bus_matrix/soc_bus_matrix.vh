...
wire        wb_s2m_rom_err;
wire        wb_s2m_rom_rty;
wire [31:0] wb_m2s_debug_adr;
wire [31:0] wb_m2s_debug_dat;
wire  [3:0] wb_m2s_debug_sel;
wire        wb_m2s_debug_we;
wire        wb_m2s_debug_cyc;
wire        wb_m2s_debug_stb;
wire  [2:0] wb_m2s_debug_cti;
wire  [1:0] wb_m2s_debug_bte;
wire [31:0] wb_s2m_debug_dat;
wire        wb_s2m_debug_ack;
wire        wb_s2m_debug_err;
wire        wb_s2m_debug_rty;
...
wb_intercon wb_intercon0
   (.wb_clk_i       (wb_clk),
    ...
    .wb_debug_adr_o (wb_m2s_debug_adr),
    .wb_debug_dat_o (wb_m2s_debug_dat),
    .wb_debug_sel_o (wb_m2s_debug_sel),
    .wb_debug_we_o  (wb_m2s_debug_we),
    .wb_debug_cyc_o (wb_m2s_debug_cyc),
    .wb_debug_stb_o (wb_m2s_debug_stb),
    .wb_debug_cti_o (wb_m2s_debug_cti),
    .wb_debug_bte_o (wb_m2s_debug_bte),
    .wb_debug_dat_i (wb_s2m_debug_dat),
    .wb_debug_ack_i (wb_s2m_debug_ack),
    .wb_debug_err_i (wb_s2m_debug_err),
    .wb_debug_rty_i (wb_s2m_debug_rty));
